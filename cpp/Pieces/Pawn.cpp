...
private:
    ...
    bool hasMovedTwo;
public: 
    Pawn(PlayerColor color) : Piece(color, (color == PlayerColor::WHITE) ? 'P' : 'p'), hasMoved(false), hasMovedTwo(false) {}
    ...
    bool threatensPosition(int x, int y, Board& board) {
    ...
    std::vector<std::vector<int>> generatePossibleMoves(int startX, int startY, Board& board) {
