...
public class Board {
    ...
    public void initializePieces() {
        ...
        pieces[7][3] = new Queen(PlayerColor.WHITE);
        pieces[7][4] = new King(PlayerColor.WHITE);
        pieces[7][5] = new Bishop(PlayerColor.WHITE);
        pieces[7][6] = new Knight(PlayerColor.WHITE);
        ...
        pieces[0][3] = new Queen(PlayerColor.BLACK);
        pieces[0][4] = new King(PlayerColor.BLACK);
        pieces[0][5] = new Bishop(PlayerColor.BLACK);
        pieces[0][6] = new Knight(PlayerColor.BLACK);
